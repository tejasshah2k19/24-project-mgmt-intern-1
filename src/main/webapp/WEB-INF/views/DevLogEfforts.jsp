...
<title>PMT | Dev Log Efforts</title>
		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<h1 class="m-0 text-dark">Log Efforts</h1>
				</div>
			</section>
			<section class="content">
				<div class="container-fluid">
					...
					<div class="card">
						<div class="card-body">
							<form action="devlogefforts" method="post">
								...
								<div class="form-group">
									<label>Add Utilized Minutes</label>
									<input type="number" min="0" class="form-control" name="utilizedMinutes" value="0">
								</div>
								<div class="form-group">
									<label>Log Date</label>
									<input type="date" class="form-control" name="logDate" value="${todayDate}" max="${todayDate}">
								</div>
								<div class="form-group">
									<label>Comments (What did you work on?)</label>
									<textarea class="form-control" rows="4" name="comments"
										placeholder="Example: Fixed login validation bug, added API error handling, and tested module assignment flow."></textarea>
								</div>

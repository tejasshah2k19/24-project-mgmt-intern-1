		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-md-6">
							<h1 class="m-0 text-dark">My Tasks (Project Wise)</h1>
						</div>
						<div class="col-sm-6">
			...
			<section class="content">
				<div class="container-fluid">
					<c:if test="${empty projectTaskMap}">
						<div class="alert alert-info">No active task assignments found for you.</div>
					</c:if>

					<c:forEach items="${projectTaskMap}" var="entry">
						<div class="row">
							<div class="col-md-12">
								<div class="card">
											...
											<tbody>
												<c:forEach items="${entry.value}" var="t">
													<tr>
														...
														<td><a href="devtaskuser?taskId=${t.taskId}">Users</a> | <a
															href="devviewtask?taskId=${t.taskId}">View</a> | <a

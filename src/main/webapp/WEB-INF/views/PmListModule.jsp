		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-md-6">
							<h1 class="m-0 text-dark">${project.title}'s Modules</h1>
						</div>
						<div class="col-sm-6">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<a href="pmnewmodule?projectId=${project.projectId}">Add New Module</a>
								</div>
											...
											<c:forEach items="${modules}" var="m">
												<tr>
													...
													<td><a href="viewmodule?moduleId=${m.moduleId}">View</a> |
														<a href="pmlisttask?moduleId=${m.moduleId}">Task</a> |
														<a href="pmnewtask?moduleId=${m.moduleId}">Add Task</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>

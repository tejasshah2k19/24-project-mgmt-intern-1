		...
		<div class="content-wrapper">
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-md-6">
							<h1 class="m-0 text-dark">Module Management</h1>
						</div>
						<div class="col-sm-6">
									...
									<table class="table table-hover text-nowrap">
										...
										<tbody>
											<c:forEach items="${modules}" var="m">
												<tr>
													<td>${projectMap[m.projectId].title}</td>
													<td>${m.moduleName}</td>
													...
													<td><a href="pmlisttask?moduleId=${m.moduleId}">Tasks</a> |
														<a href="pmnewtask?moduleId=${m.moduleId}">Add Task</a> |
														<a href="viewmodule?moduleId=${m.moduleId}">View</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>

...
<body class="hold-transition sidebar-mini layout-fixed">
 ...
 -->
								...
								<div class="card-body">
									<a href="listtask?moduleId=${module.moduleId}">Back</a><br>
									<br> <b>Project Title</b> : ${project.title}<br> 
									<b>Module
										Name</b>:${module.moduleName }<Br> 
									...
									<Br> <b>Estimated Minutes </b>:${task.estimatedMinutes } <Br>
